...
const Contact = () => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        "template_17us8im",
        {
          ...
          to_email: "itspraveen.universe@gmail.com",
  ...
  return (
    <section className="relative flex items-center c-space section-spacing">
      ...
      />
      {showAlert && (
        <Alert role="alert" aria-live="polite" type={alertType} text={alertMessage} />
      )}
      <div className="flex flex-col items-center justify-center max-w-md p-5 mx-auto border border-white/10 rounded-2xl bg-primary">
        <div className="flex flex-col items-start w-full gap-5 mb-10">
          <h2 className="text-heading">Let's Talk</h2>
          <p className="font-normal text-neutral-400">
            Whether you’re designing a new digital experience or enhancing an existing platform,
            I craft intuitive and engaging solutions to bring your ideas to life.
          </p>
        </div>
